...
Our color system is built on Tailwind CSS v4's color palette, which uses the OKLCH color space for better color reproduction and accessibility. Each color has a range of shades from 50 to 950, with 500 being the base color.
