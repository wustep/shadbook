...
<div className="grid grid-cols-2 gap-4">
	<div className="z-[0]">
		```jsx
		<div className="animate-in slide-in-from-left slide-out-to-right duration-2000 repeat-infinite direction-normal">
			Normal
		</div>
		<div className="animate-in slide-in-from-right slide-out-to-left duration-2000 repeat-infinite direction-reverse">
			Reverse
		</div>
		<div className="animate-in slide-in-from-left duration-2000 repeat-infinite direction-alternate">
			Alternate
		</div>
	...
	<div className="space-y-4">
		<Card
			className="animate-in slide-in-from-left slide-out-to-right duration-2000 repeat-infinite direction-normal bg-red-200"
			data-animation-container
		>
		...
		<Card
			className="animate-in slide-in-from-right slide-out-to-left duration-2000 repeat-infinite direction-reverse bg-orange-200"
			data-animation-container
		>
			<CardContent className="p-4 flex items-center justify-between">
				<span>◀</span>
		...
		<Card
			className="animate-in slide-in-from-left duration-2000 repeat-infinite direction-alternate bg-green-200"
			data-animation-container
		>
			<CardContent className="p-4 flex items-center justify-between">
				<span>◀</span>
				<span>Alternate (Back and Forth)</span>
				<span>▶</span>
			</CardContent>
		</Card>
		<Card
		...
		>
			<CardContent className="p-4 flex items-center justify-between">
				<span>◀</span>
				<span>Alternate Reverse (Opposite)</span>
				<span>▶</span>
			</CardContent>
		</Card>
	</div>
...
<div className="grid grid-cols-2 gap-4">
	<div>
		```jsx
		<div className="animate-in slide-in-from-left fade-in duration-1000 fill-mode-none">
			None
		</div>
		<div className="animate-in slide-in-from-left fade-in duration-1000 fill-mode-forwards">
			Forwards
		</div>
		<div className="animate-in slide-in-from-left fade-in duration-1000 fill-mode-backwards">
			Backwards
		</div>
		<div className="animate-in slide-in-from-left fade-in duration-1000 fill-mode-both">
			Both
		</div>
		```
	</div>
	<div className="space-y-4 flex flex-col gap-5">
		<Card
			className="animate-in slide-in-from-left fade-in duration-1000 fill-mode-none bg-red-200"
			data-animation-container
		>
		...
		<Card
			className="animate-in slide-in-from-left fade-in duration-1000 fill-mode-forwards bg-orange-200"
			data-animation-container
		>
			<CardContent className="p-4">
				<div className="flex items-center gap-2">
		...
		<Card
			className="animate-in slide-in-from-left fade-in duration-1000 fill-mode-backwards bg-green-200"
			data-animation-container
		>
			<CardContent className="p-4">
				<div className="flex items-center gap-2">
					<div className="w-4 h-4 rounded-full bg-green-500"></div>
					Backwards - Uses initial state before start
				</div>
			</CardContent>
		</Card>
		<Card
			className="animate-in slide-in-from-left fade-in duration-1000 fill-mode-both bg-blue-200"
			data-animation-container
		>
			<CardContent className="p-4">
				<div className="flex items-center gap-2">
...
<div className="grid grid-cols-2 gap-4">
	<div>
		```jsx
		<div className="animate-in slide-in-from-top-48 duration-1000">
			From top 12rem
		</div>
		<div className="animate-in slide-in-from-bottom-72 duration-1000">
			From bottom 18rem
		</div>
		<div className="animate-in slide-in-from-left-96 duration-1000">
			From left 24rem
		</div>
		```
	</div>
	<div className="space-y-4">
		<Card
			className="animate-in slide-in-from-top-48 duration-1000 bg-red-200"
			data-animation-container
		>
			<CardContent className="p-4">From top 12rem</CardContent>
		</Card>
		<Card
			className="animate-in slide-in-from-bottom-72 duration-1000 bg-orange-200"
			data-animation-container
		>
			<CardContent className="p-4">From bottom 18rem</CardContent>
		</Card>
		<Card
			className="animate-in slide-in-from-left-96 duration-1000 bg-green-200"
			data-animation-container
		>
